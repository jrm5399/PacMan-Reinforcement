...
class QLearningAgent(ReinforcementAgent):
    ...
    def getQValue(self, state, action):
        ...
        """
        "*** YOUR CODE HERE ***"
        return self.Q[state][action] if state in self.Q and action in self.Q[state] else 0.0
    ...
    def update(self, state, action, nextState, reward):
        ...
        # for i in range(leg)
        # if state == (1,2):
        #    graph.append(self.Q[state])

        # #Writing data to CSV
        # with open('Q3plots.csv', 'w', encoding='UTF8') as f:
        #     writer = csv.writer(f)
